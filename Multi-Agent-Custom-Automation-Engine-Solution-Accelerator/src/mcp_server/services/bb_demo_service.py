"""
Demo Service - Template tools and resources for Banco do Brasil Internal Developer Platform
"""
...
class BBDemoService(MCPToolBase):
    """Demo service with template tools and resources for BB Internal Developer Platform."""
