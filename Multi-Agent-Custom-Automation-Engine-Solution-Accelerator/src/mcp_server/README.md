...
A FastMCP-based Model Context Protocol (MCP) server for the Multi-Agent Custom Automation Engine (BB) solution accelerator.
...
This project is part of the BB Solution Accelerator and follows the same licensing terms.
